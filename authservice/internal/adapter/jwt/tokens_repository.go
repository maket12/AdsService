...
func (s *TokenRepository) ParseAccessToken(ctx context.Context, token string) (*model.AccessClaims, error) {
	var c model.AccessClaims
...
func (s *TokenRepository) ParseRefreshToken(ctx context.Context, token string) (*model.RefreshClaims, error) {
	var c model.RefreshClaims
