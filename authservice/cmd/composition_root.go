...
import (
	grpcout "ads/authservice/internal/adapters/out/grpc/discount"
	kafkaout "ads/authservice/internal/adapters/out/kafka"
	"ads/authservice/internal/adapters/out/postgres/outboxrepo"
	"ads/authservice/internal/core/application/eventhandlers"
	"ads/authservice/internal/core/application/usecases/commands"
	"ads/authservice/internal/core/application/usecases/queries"
	"ads/authservice/internal/core/domain/model/basket"
	"ads/authservice/internal/core/domain/services"
	"ads/authservice/internal/core/ports"
	"ads/internal/adapters/out/postgres"
...
func (cr *CompositionRoot) NewUnitOfWork() ports2.UnitOfWork {
